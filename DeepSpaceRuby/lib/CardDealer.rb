...
class CardDealer 
    ...
    def createEnemies() 
        regularLoot0=Loot.new(1,2,1,1,1,true,false)
        regularLoot1=Loot.new(1,1,2,1,1,false,true)
        badLoot=Loot.new(1,1,1,0,1,true)
        goodLoot=Loot.new(2,2,2,1,2,true,false)
        ...
        @enemies.add(EnemyStarShip.new("Enemigo fácil -1",0,0,regularLoot0,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil -1",0,10,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil -1",10,0,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil 0",10,10,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil 0",10,10,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil 0",10,10,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil 1",10,20,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil 1",10,20,badLoot,lowDamage2));
        @enemies.add(EnemyStarShip.new("Enemigo fácil 1",10,20,badLoot,lowDamage2));
